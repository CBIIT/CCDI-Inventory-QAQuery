...
with id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, participant_filters, sample_diagnosis_filters, survival_filters, treatment_filters, treatment_response_filters, library_selection,library_source_material, library_source_molecule, library_strategy
with id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, case participant_filters when null then [null] else participant_filters end as participant_filters, case sample_diagnosis_filters when null then [null] else sample_diagnosis_filters end as sample_diagnosis_filters, case survival_filters when null then [null] else survival_filters end as survival_filters, case treatment_filters when null then [null] else treatment_filters end as treatment_filters, case treatment_response_filters when null then [null] else treatment_response_filters end as treatment_response_filters, library_selection,library_source_material, library_source_molecule, library_strategy
unwind participant_filters as participant_filter
with id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, participant_filter, sample_diagnosis_filters, survival_filters, treatment_filters, treatment_response_filters, library_selection,library_source_material, library_source_molecule, library_strategy
...
with id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, sample_diagnosis_filter, survival_filter, treatment_filter, treatment_response_filter, library_selection,library_source_material, library_source_molecule, library_strategy
...
with distinct id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, library_selection, library_source_material, library_source_molecule, library_strategy
call {
  with id, guid, file_name, data_category, file_type, file_description, file_size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id,library_selection,library_source_material, library_source_molecule, library_strategy
  return id as fid, guid as dig, file_name as fn, data_category as fc, file_type as ft, file_description as fd, file_size as fsize, file_mapping_level as fml, file_access as fa, md5sum as md5, study_id as sid, study_acronym as sa, study_name as sn, study_status as ss, participant_id as pid, sample_id as smid,library_selection as ls, library_source_material as lsma, library_source_molecule as lsmo, library_strategy as listr
  UNION ALL
  with study_id
...
with id, guid, file_name, data_category, file_type, file_description, file_size, ['Bytes', 'KB', 'MB', 'GB', 'TB'] AS units,
        ...
        2 as precision, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id,library_selection,library_source_material, library_source_molecule, library_strategy
with id, guid, file_name, data_category, file_type, file_description, file_size, file_size /(1024^i) AS value,
        ...
        units[i] as unit, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, library_selection,library_source_material, library_source_molecule, library_strategy
with id, guid, file_name, data_category, file_type, file_description, unit,
        round(factor * value)/factor AS size, file_access, file_mapping_level, md5sum, study_id, study_acronym, study_name, study_status, participant_id, sample_id, library_selection, library_source_material, library_source_molecule, library_strategy     
with DISTINCT id,
        file_name,
        data_category,
        file_description,
